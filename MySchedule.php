                                ...
                                foreach ($apts as $apt) {
                                    ...
                                    echo "<ul>";
                                        ...
                                        if($day == 1)
                                        {
                                            ...
                                            echo "<button type='button' id = 'popoverInfo' class='btn btn-xs btn-info' data-toggle='popover' title='Popover title' data-content='And here's some amazing content. It's very engaging. Right?'>Detail</button>";
